/* Generated by ST25R3916 Discovery GUI 1.0.0.0 */
/******************************************************************************
  * @attention
  *
...
const uint8_t rfalAnalogConfigCustomSettings[] = {
    ...
    MODE_ENTRY_16_REG(0x0000,
        ...
        0x0068,0x20,0x00, /* External Load Modulation Selection (lm_ext) : External Load modulation disabled ; Disable Internal Modulation */
        0x0068,0x10,0x10, /* Driver Load Modulation Selection (lm_dri) ; Use external Load Modulation */
        0x0008,0xf0,0x50, /* PCD to PICC FDT compensation (fdel) ; Adjust the FDT to be aligned with the bitgrid */
        0x0029,0xff,0x2f, /* User Defined ; Change RFO resistance for Load Modulation */
        0x0045,0x40,0x40, /* User Defined ; Enable start on first 4 bits */
        0x0026,0xff,0xc5, /* User Defined ; Set Antenna Tuning (Poller): ANTL v4 */
        0x0027,0xff,0xe3  /* User Defined ; Set Antenna Tuning (Poller): ANTL v4 */
    ),
    ...
    MODE_ENTRY_3_REG(0x0802,
        0x000b,0x38,0x00, /* User Defined ; Set Rx filter configuration */
        0x000b,0x0f,0x01, /* First and Third stage zero setting (rec1) : 1st: 12 kHz; 3rd: 200 kHz ; Set Rx filter configuration */
        0x000c,0x40,0x40  /* AM demodulator type select (amd_sel) ; AM demodulator: mixer */
    ),
    ...
    MODE_ENTRY_9_REG(0x0006,
        0x0026,0xff,0x00, /* User Defined ; Set Antenna Tuning (Listener): ANTL */
        0x0027,0xff,0x00, /* User Defined ; Set Antenna Tuning (Listener): ANTL */
        0x000b,0x38,0x00, /* User Defined ; Set Rx filter configuration */
        0x000b,0x0f,0x01, /* First and Third stage zero setting (rec1) : 1st: 12 kHz; 3rd: 200 kHz ; Set Rx filter configuration */
        0x000c,0x40,0x40, /* AM demodulator type select (amd_sel) ; AM demodulator: mixer */
        0x0070,0xff,0x00, /* User Defined ; Disable Overshoot Protection */
    ...
    /* Mode Name: LISTEN_AP2P_COMMON_RX, Mode ID: 0x8802 */
    MODE_ENTRY_3_REG(0x8802,
        0x000b,0x38,0x00, /* User Defined ; Set Rx filter configuration */
        0x000b,0x0f,0x01, /* First and Third stage zero setting (rec1) : 1st: 12 kHz; 3rd: 200 kHz ; Set Rx filter configuration */
        0x000c,0x40,0x40  /* AM demodulator type select (amd_sel) ; AM demodulator: mixer */
    ),
